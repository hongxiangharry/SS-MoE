...
if __name__ == "__main__":
    ...
    raw_data_filename = 'aniso.nii.gz' # original
    ...
    # search sub-folder
    subs = [os.path.basename(os.path.dirname(path)) for path in glob.glob(dataset_dir+'/testsbj*/'+raw_data_filename)]
