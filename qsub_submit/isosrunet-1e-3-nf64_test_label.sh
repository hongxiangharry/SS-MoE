...
python main_iso_test.py --retrain -jn iso_lr1e-3_p888_sbj4_nf64 --approach IsoSRUnet -nf 64 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 64 -lr 1e-3 -j $JOB_ID -vs 0 -ntp 215936 -mnp 100 -ip 8 8 8 -op 16 16 16 -opt 8 8 8 -es 4 4 4 -est 4 4 4
