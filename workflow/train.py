...
from dataloader.SuperMUDI import DefineTrainValSuperMudiDataloader, DefineTrainValSuperMudiDataloader_Stage2, DefineTrainValSuperMudiDataloader_Stage3
from tensorflow.keras.models import Model
from tensorflow.keras import Input
from tensorflow.keras.layers import GlobalAveragePooling3D # return the (batchsize, channel)
...
def training(gen_conf, train_conf) :
    ...
    para = 'nopara'
    csv_path = './csv_files/Stage2_label_train.csv'
    mse_array = []
...
def training_S3(gen_conf, train_conf) :
    ...
    print("Set up data loader ...")
    train_generator_1, val_generator_1 = DefineTrainValSuperMudiDataloader_Stage3(gen_conf, train_conf, csv_path='./csv_files/Stage2_batchnormalization_Level_1_label.csv', para='para')
    train_generator_2, val_generator_2 = DefineTrainValSuperMudiDataloader_Stage3(gen_conf, train_conf, csv_path='./csv_files/Stage2_batchnormalization_Level_2_label.csv', para='para')
    train_generator_3, val_generator_3 = DefineTrainValSuperMudiDataloader_Stage3(gen_conf, train_conf, csv_path='./csv_files/Stage2_batchnormalization_Level_3_label.csv', para='para')
    train_generator_4, val_generator_4 = DefineTrainValSuperMudiDataloader_Stage3(gen_conf, train_conf, csv_path='./csv_files/Stage2_batchnormalization_Level_4_label.csv', para='para')
...
def __train_model_S3(gen_conf, train_conf, train_generator_1, train_generator_2, train_generator_3, train_generator_4, val_generator_1, val_generator_2, val_generator_3, val_generator_4, case_name, callbacks_1, callbacks_2,callbacks_3,callbacks_4, vis_flag=False):
    ...
    model_1.load_weights('./pre_trained/0-IsoSRUnet-3-(8, 8, 8)-(4, 4, 4).h5')
    model_2.load_weights('./pre_trained/0-IsoSRUnet-3-(8, 8, 8)-(4, 4, 4).h5')
    model_3.load_weights('./pre_trained/0-IsoSRUnet-3-(8, 8, 8)-(4, 4, 4).h5')
    model_4.load_weights('./pre_trained/0-IsoSRUnet-3-(8, 8, 8)-(4, 4, 4).h5')
