...
def train_model_generator(gen_conf, train_conf, train_generator, val_generator, case_name = 0):
    ...
    # choose weight here
    stored_path = '{}/{}/S2-para-batchnormalization-IsoSRUnet-3-(8, 8, 8)-(4, 4, 4).h5'.format(gen_conf['model_path'],train_conf['dataset'])
    ...
    Data4stage2.to_csv('./csv_files/Stage2_batchnormalization_Level_1_label.csv', index = None, encoding='utf8')

    Data4stage2 = pd.DataFrame({'Name':Second_level_name, 'Label': Second_level_label, 'Prediction':Second_level})
    Data4stage2.to_csv('./csv_files/Stage2_batchnormalization_Level_2_label.csv', index = None, encoding='utf8')

    Data4stage2 = pd.DataFrame({'Name':Third_level_name, 'Label': Third_level_label, 'Prediction':Third_level})
    Data4stage2.to_csv('./csv_files/Stage2_batchnormalization_Level_3_label.csv', index = None, encoding='utf8')

    Data4stage2 = pd.DataFrame({'Name':Fourth_level_name, 'Label': Fourth_level_label, 'Prediction':Fourth_level})
    Data4stage2.to_csv('./csv_files/Stage2_batchnormalization_Level_4_label.csv', index = None, encoding='utf8')
