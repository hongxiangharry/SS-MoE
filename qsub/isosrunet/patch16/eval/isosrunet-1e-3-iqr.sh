...
python main_iso.py -jn iso_lr1e-3_p161616_iqr --approach IsoSRUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 16 -lr 1e-3 -j $JOB_ID -ntp 20000 -mnp 10 -ip 16 16 16 -op 32 32 32 -opt 16 16 16 -es 8 8 8 -est 8 8 8
