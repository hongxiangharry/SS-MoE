...
python build_iso.py --rebuild -jn build_iso --num_subject 4 1 --approach IsoSRUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -mnp 100 -ip 8 8 8 -op 16 16 16 -opt 8 8 8 -es 4 4 4 -est 4 4 4
