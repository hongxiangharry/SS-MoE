...
ZIP_FILE="/cluster/project0/IQT_Nigeria/others/SuperMudi/patch/iso-(8, 8, 8)-(4, 4, 4)-2-iqr.zip"
...
python main_iso_eval.py -jn iso_lr1e-3_p888_sbj2_iqr --no_subject 2 3 --approach IsoSRUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 64 -lr 1e-3 -j $JOB_ID -ntp 50000 -mnp 100 -ip 8 8 8 -op 16 16 16 -opt 8 8 8 -es 4 4 4 -est 4 4 4
