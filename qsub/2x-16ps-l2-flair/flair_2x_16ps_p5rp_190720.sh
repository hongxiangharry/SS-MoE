...
python main_flair_2x.py -jn 250720_Aniso_flair_16ps_3nl_lrp5 --approach AnisoUnet -es 8 8 4 -est 8 8 4 -ip 16 16 8 -op 16 16 16 -opt 8 8 8 -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -lr 1e-5
