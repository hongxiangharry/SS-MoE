...
python main_flair_8x.py -jn 190720_Aniso_flair_8x_16ps_4nl --approach AnisoUnet -es 8 8 1 -est 8 8 1 -ip 16 16 2 -op 16 16 16 -opt 8 8 8 -nf 16 -nk 2 -mt 2 -nl 4 -c 1
