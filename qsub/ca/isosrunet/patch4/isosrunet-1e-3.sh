...
python main_iso.py --retrain -jn iso_lr1e-3_p444 --approach IsoSRUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 16 -lr 1e-3 -j $JOB_ID -ip 4 4 4 -op 8 8 8 -opt 8 8 8 -es 4 4 4 -est 4 4 4
