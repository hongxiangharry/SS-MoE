...
python main_iso.py --retrain -jn isoca_1e-4_rr8_p888 --approach IsoCAUnet -nf 16 -nk 2 -mt 2 -nl 3 -cas 0.1 -carr 8 -c 1 -ne 100 -bs 64 -lr 1e-4 -j $JOB_ID -ntp 100000 -mnp 100 -ip 8 8 8 -op 16 16 16 -opt 8 8 8 -es 4 4 4 -est 4 4 4
