...
ZIP_FILE="/cluster/project0/IQT_Nigeria/others/SuperMudi/patch/iso-(16, 16, 16)-(16, 16, 16).zip"
...
python main.py --retrain -jn aunet_lr1e-3_p16168 --approach AnisoUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 16 -lr 1e-3 -j $JOB_ID -ip 16 16 8 -op 16 16 16 -opt 16 16 16 -es 16 16 8 -est 16 16 8
