...
python build.py --rebuild -jn build_aniso --no_subject 2 3 --approach AnisoUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -mnp 100 -ip 16 16 8 -op 16 16 16 -opt 8 8 8 -es 8 8 4 -est 8 8 4
