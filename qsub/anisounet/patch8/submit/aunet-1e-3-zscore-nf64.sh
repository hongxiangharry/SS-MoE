...
python main_test.py -jn aunet_lr1e-3_p16168_z_nf64 --approach AnisoUnet -nf 64 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 64 -lr 1e-3 -j $JOB_ID -vs 0 -ntp 270000 -mnp 100 -ip 16 16 8 -op 16 16 16 -opt 8 8 8 -es 8 8 4 -est 8 8 4 -od zscore
