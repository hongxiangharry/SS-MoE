...
ZIP_FILE="/cluster/project0/IQT_Nigeria/others/SuperMudi/patch/aniso-(32, 32, 16)-(32, 32, 16).zip"
...
python main.py --retrain -jn aunet_1e-3_nl5 --approach AnisoUnet -nf 16 -nk 2 -mt 2 -nl 5 -c 1 -ne 100 -bs 16 -lr 1e-3 -j $JOB_ID
