...
ZIP_FILE="/cluster/project0/IQT_Nigeria/others/SuperMudi/patch/aniso-(32, 32, 16)-(16, 16, 8)-.zip"
...
python main.py -jn aunet_lr1e-3_p323216 --approach AnisoUnet -nf 16 -nk 2 -mt 2 -nl 3 -c 1 -ne 100 -bs 16 -lr 1e-3 -j $JOB_ID -ntp 20000 -mnp 10 -ip 32 32 16 -op 32 32 32 -opt 16 16 16 -es 16 16 8 -est 16 16 8
