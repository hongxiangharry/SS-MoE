...
if __name__ == "__main__":
    ...
    interp_data_filename = 'interp-aniso.nii.gz'
    gt_data_filename = 'org.nii.gz'
    brain_mask_filename = 'brain_mask.nii.gz'

    mse_save_filename = 'aniso_interp_mse_array.txt'

    zscore_filename = 'aniso-interp_zscore.txt'
    zscore_th = 2.5
    iqr_filename = 'aniso-interp_iqr.txt'
