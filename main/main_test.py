...
from config_test import general_configuration as gen1_conf
from config_test import test_configuration as test_conf
...
testing(gen1_conf, test_conf, case_name=case_name)
