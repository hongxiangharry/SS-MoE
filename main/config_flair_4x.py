general_configuration = {
    ...
    'dataset_info' : {
        'MBB': {
            'format' : 'nii',
            'dimensions': (196, 256, 168), # output shape
            'num_volumes': [15, 15], # train and test
            'modalities': 1,
            'general_pattern': '{}_{}.nii',
            'path': '/cluster/project0/IQT_Nigeria/mbb-dataset/process',
            'subname_len': 6,
            'in_postfix': 'sim_4x', ## todo: look at this from dataset
            'interp_postfix': 'sim_4x_interp',
            'out_postfix' : 'gt_4x',
        ...
        'Nigeria19-Multimodal': {
            'format' : 'nii.gz',
            'dimensions': (300, 300, 108), # output shape
