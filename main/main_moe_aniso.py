...
from config_moe_aniso import general_configuration as gen_conf
from config_moe_aniso import training_configuration as train_conf
from config_moe_aniso import test_configuration as test_conf
