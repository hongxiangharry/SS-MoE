...
from config_flair_6x import general_configuration as gen_conf
from config_flair_6x import training_configuration as train_conf
from config_flair_6x import test_configuration as test_conf
