...
from config_t2_k8 import general_configuration as gen_conf
from config_t2_k8 import training_configuration as train_conf
from config_t2_k8 import test_configuration as test_conf
