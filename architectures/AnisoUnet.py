...
def __generate_hetero_unet_model_1dir(
    ...
    if thickness_factor == 2:
        ...
        # conv6 = get_conv_core(dimension, conv5, int(num_filters*16/downsize_factor), num_kernel=num_kernels) ## c1024
        # up6 = get_deconv_layer(dimension, conv6, int(num_filters*8/downsize_factor)) ## c1024
        # up6 = concatenate([up6, conv4], axis=1) ## c1024+1024
        #
        # conv7 = get_conv_core(dimension, up6, int(num_filters*8/downsize_factor), num_kernel=num_kernels)  ## c1024
        ...
        # pool4 = get_max_pooling_layer(dimension, conv4)
        # conv4 = get_shuffling_operation(dimension, conv4, n_bb_mapping, temp_sparse_scale) ## c1024
        # conv5 = get_conv_core(dimension, pool4, int(num_filters*16/downsize_factor), num_kernel=num_kernels) ## c2048
        #
        # # pool5 = get_max_pooling_layer(dimension, conv5)
        # # conv5 = get_shuffling_operation(dimension, conv5, n_bb_mapping, sparse_scale) ## c64
        # # conv6 = get_conv_core(dimension, pool5, int(num_filters*32/downsize_factor)) ## c512
        #
        # # reshape1 = get_shuffling_operation(dimension, conv5, n_bb_mapping, temp_sparse_scale) ## c2048
        #
        #
        # conv6 = get_conv_core(dimension, conv5, int(num_filters*16/downsize_factor), num_kernel=num_kernels) ## c1024
        # up6 = get_deconv_layer(dimension, conv6, int(num_filters*8/downsize_factor)) ## c1024
    ...
    #     pool1 = get_max_pooling_layer(dimension, conv1, (2, 2, 1))
    #     conv1 = get_shuffling_operation(dimension, conv1, n_bb_mapping, temp_sparse_scale)  ## c2
    ...
    #     pool2 = get_max_pooling_layer(dimension, conv2, (2, 2, 1))
    #     conv2 = get_shuffling_operation(dimension, conv2, n_bb_mapping, temp_sparse_scale)  ## c8
    ...
    #     conv3 = get_shuffling_operation(dimension, conv3, n_bb_mapping, temp_sparse_scale)  ## c32
    ...
    #     pool4 = get_max_pooling_layer(dimension, conv4)
    #     conv4 = get_shuffling_operation(dimension, conv4, n_bb_mapping, temp_sparse_scale)  ## c128
